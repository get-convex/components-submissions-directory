...
- npm/Repo/Website/Demo/Security action buttons per package (Security opens a security report modal with scan status, providers, recommendations, and contact author section)
