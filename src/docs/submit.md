...
2. **GitHub or GitLab repository** - Public source code repository on github.com or gitlab.com. Both hosts get the same treatment: preflight, README based content generation, issues list, and author avatar. Monorepo subdirectory URLs (`/tree/main/packages/x` or `/-/tree/main/packages/x`) are accepted
...
| Repository URL | Link to your public GitHub or GitLab repo |
...
3. The AI fetches your repository README (GitHub or GitLab), analyzes it with Convex docs context, and produces structured content
...
- Contact author section linking to the repository's Issues page (GitHub or GitLab)
